...
// Define the BentoGridThirdDemo component
...
const SkeletonFive = () => {
  return (
    <div className="flex flex-1 w-full h-full min-h-[6rem] dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex-row space-x-2 justify-center items-center">
      <div className="w-2/3 rounded-lg bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 p-2 h-12"></div>
      <div className="w-1/3 rounded-lg bg-gradient-to-r from-yellow-400 via-green-500 to-teal-500 p-2 h-12"></div>
    </div>
  );
};
